...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2024 at 05:32 AM
...
(1, 'Giảm 10%', 'Đơn tối thiểu đ50K\r\nGiảm tối đa 30K', 'Vàng', 1, 10, '2024-11-01', '2024-11-30'),
(2, 'Giảm 30K', 'Giảm 30K cho đơn tối thiểu 70k\r\nÁp dụng lấy mã', 'Vàng', 1, 30, '2024-11-20', '2024-11-21'),
(3, 'Giảm 8%', 'Đơn tối thiểu đ30K\r\nGiảm tối đa 20K', 'Bạc', 1, 8, '2024-11-02', '2024-11-26'),
...
(6, 'Giảm 50K', 'Hóa đơn tối thiểu 150k', 'Kim cương', 1, 50, '2024-12-07', '2024-12-07'),
